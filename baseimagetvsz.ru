...
class TVSZImage(qrcode.image.base.BaseImage):
    """
    ...
    def new_image(self, **kwargs):
        mask = Image.open("C:\\enviroment\\qr\\tvsz2.png")
    ...
    def drawrect(self, row, col):
        ...
        #print self.mask[mask_x, mask_y]

        if ( mask_y < 0 or mask_y >= self.mask_size[1] or self.mask[mask_x, mask_y] == (255, 255, 255)or self.mask[mask_x, mask_y] == (255, 255, 255, 255)):
